...
Revises: None
Create Date: 2016-11-29 16:59:20.133402

"""

# revision identifiers, used by Alembic.
revision = '660618c660d1'
down_revision = None
...
def upgrade():
    ...
    op.create_index('address_summary_dor_parcel_id_idx', 'address_summary', ['dor_parcel_id'], unique=False, postgresql_using='btree')
    op.create_index('address_summary_opa_account_num_idx', 'address_summary', ['opa_account_num'], unique=False, postgresql_using='btree')
    op.create_index('address_summary_pwd_parcel_id_idx', 'address_summary', ['pwd_parcel_id'], unique=False, postgresql_using='btree')
...
def downgrade():
    ...
    op.drop_index('address_summary_pwd_parcel_id_idx', table_name='address_summary')
    op.drop_index('address_summary_opa_account_num_idx', table_name='address_summary')
    op.drop_index('address_summary_dor_parcel_id_idx', table_name='address_summary')
