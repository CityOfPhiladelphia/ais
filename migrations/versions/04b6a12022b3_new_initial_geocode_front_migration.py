"""New initial geocode_front migration.

Revision ID: 04b6a12022b3
Revises: None
Create Date: 2017-10-18 15:52:26.793370

"""

# revision identifiers, used by Alembic.
revision = '04b6a12022b3'
down_revision = None
...
def upgrade():
    ...
    sa.Column('unit_num', sa.Text(), nullable=True),
    sa.Column('street_full', sa.Text(), nullable=True),
    sa.Column('building_yn', sa.Text(), nullable=True),
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='MULTIPOLYGON', srid=2272), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
