...
Revision ID: 1ffd47933a30
Revises: dffe58fef261
Create Date: 2016-03-24 14:09:14.871735

"""

# revision identifiers, used by Alembic.
revision = '1ffd47933a30'
down_revision = 'dffe58fef261'
...
def upgrade():
    ...
    sa.Column('geometry', geoalchemy2.types.Geometry(geometry_type='MULTIPOLYGON', srid=2272), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('street_address', sa.Text(), nullable=True),
    sa.Column('geocode_type', sa.Text(), nullable=True),
    sa.Column('geometry', geoalchemy2.types.Geometry(geometry_type='POINT', srid=2272), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('seg_id', sa.Integer(), nullable=True),
    sa.Column('parcel_source', sa.Text(), nullable=True),
    sa.Column('geometry', geoalchemy2.types.Geometry(geometry_type='LINESTRING', srid=2272), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
