...
#the_el write t_dor_parcel_address_analysis --connection-string $oracle_dsn_gis_ais --table-schema-path dor_parcel_address_analysis_schema.json --geometry-support sde --from-srid 2272 --input-file dor_parcel_address_analysis.csv --skip-headers
#if [ $? -ne 0 ]
#then
