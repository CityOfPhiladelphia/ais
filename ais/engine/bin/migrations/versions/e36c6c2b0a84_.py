...
Revision ID: e36c6c2b0a84
Revises: None
Create Date: 2016-11-09 17:12:04.906640

"""

# revision identifiers, used by Alembic.
revision = 'e36c6c2b0a84'
down_revision = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('street_code_1', sa.Text(), nullable=True),
    sa.Column('street_code_2', sa.Text(), nullable=True),
    sa.Column('int_ids', sa.Text(), nullable=True),
    sa.Column('geom', geoalchemy2.types.Geometry(geometry_type='POINT', srid=2272), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
